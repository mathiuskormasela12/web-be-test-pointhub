...
## Entity Relationship Diagram (ERD) & API Docs Generated By Swagger UI (Task 1)

- API Docs Local : http://localhost:3000/docs (use the port that you set on the env file)
- API Docs Netlify : https://celadon-palmier-2b8644.netlify.app
- ERD
